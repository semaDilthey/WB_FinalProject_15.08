...
struct InAppBookModel: BookInterface {
    var id: UUID
    var title: String
    var authors: [String]?
    var image: UIImage?
...
extension InAppBookModel {
    ...
    static func fromDecodableBook(_ book: Book) -> Self {
        return InAppBookModel(id: UUID(), title: book.title, authors: book.author_name)
    }
